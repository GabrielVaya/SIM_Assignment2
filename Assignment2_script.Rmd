...
Boxplot(df$MonthlyCharges,range=3,id=list(n=Inf,labels=rownames(df))) #No extreme univariate outliers
```
...
Boxplot(df$TotalCharges,range=3,id=list(n=Inf,labels=rownames(df))) #No extreme univariate outliers
```
